...
![CAD]({{ "/assets/images/TorqueWrenchCAD.jpg" | relative_url }}){: width="80%" .center }
![CADTopPlane]({{ "/assets/images/TopPlane.jpg" | relative_url }}){: width="80%" .center }
![CADRightPlane]({{ "/assets/images/RightPlane.jpg" | relative_url }}){: width="80%" .center }
...
![Loads and BC]({{ "/assets/images/Loads_BC.jpg" | relative_url }}){: width="60%" .center }

Here are the normal strain contours from my FEM 

![normalstrain]({{ "/assets/images/NormalStrainContours.jpg" | relative_url }}){: width="60%" .center }
...
![Max Normal Stress]({{ "/assets/images/MaxPrincipalStress.jpg" | relative_url }}){: width="60%" .center }
...
![Load Point Deflection]({{ "/assets/images/Deformation.jpg" | relative_url }}){: width="60%" .center }
...
![Strain Probe]({{ "/assets/images/StrainProbe.jpg" | relative_url }}){: width="60%" .center }
![Strain Gauge Results]({{ "/assets/images/StrainGaugeResults.jpg" | relative_url }}){: width="60%" .center }
...
![Strain Gauge]({{ "/assets/images/straingaugeproduct.jpg" | relative_url }}){: width="60%" .center }
![Strain Gauge Dim]({{ "/assets/images/SGdimensions.jpg" | relative_url }}){: width="60%" .center }
