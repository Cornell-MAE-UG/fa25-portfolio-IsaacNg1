...
![Shock Absorber within Washing Machine]({{ "/assets/images/SAinWM.jpg" | relative_url }}){: .inline-image-r}

This is how I modeled the shock absorber within the washing machine

![Photo of ODE]({{ "/assets/images/SA-FinalODE.jpg" | relative_url }}){: .inline-image-l}
...
![Photo of State Space]({{ "/assets/images/SA-StateSpace.jpg" | relative_url }}){: .inline-image-l}
